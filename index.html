		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					...
					<h1><strong>I am Osideinde Oluwadara</strong>, a super simple<br />
					and creative student of the Federal University of Agriculture Abeokuta<br />
					Favorite Code -- <a href="#">Html</a>.</h1>
				</div>
			</header>
				...
				<!-- One -->
					<section id="one">
						<header class="major">
							...
							<br>
							Well i can say the current administration is trying but all thier efforts are being nunilfied by the other political parrties because of selfish ambitions wchich shoudnt be so.
						</P>
						<ul class="actions">
							...
							<div class="4u$ 12u$(small)">
								<ul class="labeled-icons">
									<li>
										...
										1, Bello Owolabi Street,.<br />
										Iyana-Ipaja, Lagos State<br />
										Nigeria
									</li>
									<li>
		...
		<!-- Footer -->
			<footer id="footer">
				<div class="inner">
					...
					<ul class="copyright">
						<li>&copy; osideinde</li><li>Designed by: <a href="#">Osideinde Oluwadara</a></li>
					</ul>
				</div>
			</footer>
